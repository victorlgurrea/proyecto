...
<div class="card mt-5">
         <div class="card-header">
            <div class="col-md-12">
                <h4 class="card-title"><strong>{{ __('create_subscription')}}</strong>  
                ...
                <div class="row">
                    <div class="col-3 offset-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="min_labels" name="min_labels" value="">
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-group">
                            <label for="max_labels">{{__('max_labels')}}: </label>
                            <input type="number" class="form-control" id="max_labels" name="max_labels" value="">
                        </div>
                    </div>
                </div>
                <div class="row">
